...
'cookie_pre' => 'GoVXv_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://www.aaa.com/uploadfile/', //附件路径
...
'app_path' => 'http://localhost:7030/house5_server/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'relative_path' => 0,//是否开启URL相对地址
'auth_key' => 'UbEOMO5qakgmNAI9sM2e', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.aaa.com/house5_server',	//接口地址
'phpsso_auth_key' => 'NGuklbw58Q5madEodp9u9MvMZ7PbRNLp', //加密密钥
'phpsso_version' => '1', //phpsso版本

'html_root' => '/news',//生成静态文件路径
'safe_card'=>'1',//是否启用口令卡
