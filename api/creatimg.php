...
$fontpath = H5_PATH.'libs'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR;
...
if(intval($_GET['transparent']) == 1) imagecolortransparent($im,$white);
