...
$this->update_url = 'http://update.house5.net/index.php';
$this->http = h5_base::load_sys_class('http','',1);
...
$string = '';
$db = h5_base::load_model('pay_payment_model');
...
function check_uuid(){
$site_db = h5_base::load_model('site_model');
