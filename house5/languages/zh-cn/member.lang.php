...
$LANG['between_3_to_20'] = '应该为3-20位之间';
...
$LANG['member_group_dayprice'] = '每日';
$LANG['member_group_monthprice'] = '每月';
$LANG['member_group_yearprice'] = '每年';
$LANG['member_group_biaoqian'] = '标签条数';
$LANG['member_group_xintui'] = '新推';
$LANG['member_group_jishou'] = '急售';
$LANG['member_group_tuijian'] = '推荐';
$LANG['member_group_zhiding'] = '置顶';
$LANG['member_group_shuaxin'] = '日刷新次数';
$LANG['member_group_total_nums'] = '最大发布数';
...
$LANG['member_group_upgradeprice'] = '升级价格(RMB)';
$LANG['member_group_upgradeprice2'] = '升级价格(积分)';
...
$LANG['move_member_model_index_alert'] = '1、无法删除会员模型，当模型里存在会员时请使用“移动”功能将该模型里的会员移动到其他会员模型中。<br />2、移动模型会员，将会把原有模型里的会员信息删除，将不能修复。 ';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录问房网,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录问房网,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录问房网,轻松使用盛大所有服务。';
...
$LANG['repeat_sms_code'] = '重获验证码';
$LANG['receive_sms_code'] = '短信验证码：';
...
$LANG['setting_ucuse'] = '是否整合ucenter:';
$LANG['setting_ucuse_yes'] = '是';
$LANG['setting_ucuse_no'] = '否';
$LANG['setting_uc_api'] = 'Ucenter地址:';
$LANG['setting_uc_api_desc'] = 'UCenter的URL地址，结尾请不要加“/”';
$LANG['setting_uc_ip'] = 'IP:';
$LANG['setting_uc_ip_desc'] = '正常情况下留空即可。';
$LANG['setting_uc_dbhost'] = 'UC数据库服务器:';
$LANG['setting_uc_dbuser'] = 'UC数据库用户名:';
$LANG['setting_uc_dbpw'] = 'UC数据库密码:';
$LANG['setting_uc_dbname'] = 'UC数据库名:';
$LANG['setting_uc_dbtablepre'] = '表前缀:';
$LANG['setting_uc_dbcharset'] = '编码:';
$LANG['setting_uc_appid'] = '应用ID:';
$LANG['setting_uc_key'] = '通信密钥:';
$LANG['setting_succ'] = 'UCenter配置保存成功';
?>