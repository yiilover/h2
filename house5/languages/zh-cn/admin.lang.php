...
$LANG['house5_title'] = 'house5 内容管理系统';
...
$LANG['user_disabled'] = '该管理员帐号已停用';//add by L 2012/12/6
...
$LANG['main_safety_permissions'] = '※ 强烈建议您将网站目录设置为644（linux/unix）或只读（NT）';
...
$LANG['main_product_team'] = 'HOUSE5开发团队';
...
$LANG['setting_relative_path'] = 'URL启用相对地址';
$LANG['setting_relative_path_desc'] = '<font color="gray">开启此项适用于多个域名绑定到同一个站点的情况</font>';
...
$LANG['email'] = 'E-mail';
$LANG['realname'] = '真实姓名';
$LANG['nickname'] = '昵称';// add by L 2012/6/1
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 HOUSE5可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
HOUSE5可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.house5.net/';
$LANG['domain_end_string'] = '格式应该为http://www.house5.net/，请以"/"结束';
...
$LANG['city_map'] = '城市坐标';
$LANG['city_map_ex'] = '如122.1|37.5';
$LANG['default_city'] = '默认城市';
$LANG['map_key'] = 'Mapabc密钥';
$LANG['map_key_ex'] = 'Mapabc地图密钥 <A href=\"http://code.mapabc.com/key.shtml\" target=\"_blank\">点击申请</A>';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.house5.net/';
$LANG['site_domain_ex2'] = '格式应该为http://www.house5.net/，请以"/"结束';
...
$LANG['setting_connect'] = '快捷登录';
$LANG['setting_dir'] = '二级域名';
$LANG['setting_weixin'] = '微信配置';
...
$LANG['admin_url_tips'] = '例如：admin.domain.com，绑定后，只能通过该域名登陆，修改参数admin_url可手动取消绑定';
$LANG['member_path'] = '会员中心域名';
$LANG['member_path_tips'] = '例如：my.domain.com，绑定后，页面上出现会员中心的地方自动启用该域名';
$LANG['house_path'] = '新房域名';
$LANG['house_path_tips'] = '例如：http://house.domain.com，绑定后，页面上出现新房的地方自动启用该域名';
$LANG['esf_path'] = '二手房域名';
$LANG['esf_path_tips'] = '例如：http://esf.domain.com，绑定后，页面上出现二手房的地方自动启用该域名';
$LANG['tuan_path'] = '看房团/团购域名';
$LANG['tuan_path_tips'] = '例如：http://tuan.domain.com，绑定后，页面上出现看房团的地方自动启用该域名';
$LANG['bbs_path'] = '论坛域名';
$LANG['bbs_path_tips'] = '例如：http://bbs.domain.com，绑定后，页面上出现论坛的地方自动启用该域名';
$LANG['weixin_token'] = '微信TOKEN';
$LANG['weixin_token_tips'] = '这个值要和微信互动平台里所填一致';
$LANG['weixin_reply'] = '微信关注自动回复';
$LANG['weixin_reply_tips'] = '当有用户关注您的微信后，会自动发送该内容';
$LANG['weixin_url'] = '微信接口地址';
$LANG['weixin_url_tips'] = '把这个地址复制粘贴到微信互动平台接口地址处';
$LANG['setting_connect_qqnew'] = 'QQ号码登录';
$LANG['setting_connect_qqcallback'] = '回调地址';

/*热门关键词 add by L 2012/7/20 */ 
