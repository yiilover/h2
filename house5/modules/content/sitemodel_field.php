...
$this->model_db = h5_base::load_model('sitemodel_model');
...
$this->cache_field($modelid);
showmessage(L('add_success'),'?s=content/sitemodel_field/init/modelid/'.$modelid.'/menuid/59');
}else {
...
$this->cache_field($modelid);
showmessage(L('update_success'),'?s=content/sitemodel_field/init/modelid/'.$modelid.'/menuid/59');
}else {
$show_header = $show_validator = $show_dialog = '';
h5_base::load_sys_class('form','',0);
require MODEL_PATH.'fields.inc.php';
