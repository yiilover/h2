...
';echo L('updateurl_tips');;echo '</div>
<div class="bk10"></div>

<div class="table-list">
<table width="100%" cellspacing="0">

<form action="?s=content/create_html/update_urls" method="post" name="myform">
...
';echo $string;;echo '</select></td>
      <td><font color="red">';echo L('every_time');;echo ' <input type="text" name="pagesize" value="100" size="4"> ';echo L('information_items');;echo '</font></td>
    </tr>
	<tr> 
...
<!--
	...
	function change_model(modelid) {
		...
		window.location.href=\'?s=content/create_html/update_urls/modelid/\'+modelid+\'/h5_hash/\'+h5_hash;
	}
//-->
</script>';?>