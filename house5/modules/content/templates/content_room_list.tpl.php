...
<a href="?s=content/room/init/catid/';echo $catid;;echo '/h5_hash/';echo $h5_hash;;echo '" ';if($steps==0 &&!isset($_GET['reject'])) echo 'class=on';;echo '><em>';echo L('check_passed');;echo '</em></a><span>|</span>
';echo $workflow_menu;;echo ' <a href="javascript:;" onclick="javascript:$(\'#searchid\').css(\'display\',\'\');"><em>';echo L('search');;echo '</em></a> |  <a href="?s=content/room/init/catid/';echo $catid;;echo '/steps/1/h5_hash/';echo $h5_hash;;echo '" ';if(isset($_GET['steps'])&&($_GET['steps']=='1')){echo 'class=on';};echo '>未审核</a>
</div>
<div id="searchid" style="display:';if(!isset($_GET['search'])) echo 'none';;echo '">
<form name="searchform" action="" method="get" >
<input type="hidden" value="content/room/init" name="s">
...
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		...
		<div class="explain-col">
				...
				房间号						
				<input name="keyword_room" type="text" value="';if(isset($keyword_room)) echo $keyword_room;;echo '" class="input-text" />
...
;echo '        <tr>
		...
		<td align=\'center\'>
		';
$ldinfo = get_relationxq($r['id'],20,19);
$lpinfo = get_relationxq($ldinfo['id'],19,14);
if($status==99) {
if($r['islink']) {
echo '<a href="'.$r['url'].'" target="_blank">';
}elseif(strpos($r['url'],'http://')!==false) {
echo "<a href='".HOUSE_PATH.$lpinfo['id']."/shapan.html' target='_blank'>";
}else {
...
echo '<a href="javascript:;" onclick=\'window.open("?s=content/content/public_preview/steps/'.$steps.'/catid/'.$catid.'/id/'.$r['id'].'","manage")\'>';
		...
		<td align=\'center\'>';echo "<a href='".HOUSE_PATH.$lpinfo['id']."/shapan.html' target='_blank'>".$ldinfo['title']."</a>";;echo '</td>
		<td align=\'center\'>';echo "<a href='".HOUSE_PATH.$lpinfo['id']."/shapan.html' target='_blank'>".$lpinfo['title']."</a>";;echo '</td>
		<td align=\'center\'>
		';
if($r['sysadd']==0) {
