...
<!--
	$(function(){
		...
		$("#name").formValidator({onshow:"';echo L('input').L('name');echo '",onfocus:"';echo L('input').L('name');echo '"}).inputValidator({min:1,onerror:"';echo L('input').L('name');echo '"}).ajaxValidator({type : "get",url : "",data :"s=tag/tag/public_name",datatype : "html",async:\'false\',success : function(data){	if( data == "1" ){return true;}else{return false;}},buttons: $("#dosubmit"),onerror : "';echo L('name').L('exists');echo '",onwait : "';echo L('connecting');echo '"});
...
<div class="pad-10">
<form action="?s=tag/tag/add&ac=';echo $ac;echo '" method="post" id="myform">
<div>
<fieldset>
  ...
  ';if ($module):;echo '    <tr>
	  ...
	  ';endif;;echo '	  ';if(isset($html[$action]) &&is_array($html[$action]) &&$action)foreach($html[$action] as $k=>$v):;echo '		  <tr>
		...
		<td class="y-bg">';echo creat_form($k,$v,'',$module);echo '</td>
	</tr>
  ...
  ';};echo '  ';endforeach;;echo '  ';elseif ($type==1) :;echo '    <tr>
		...
		<td class="y-bg"><textarea name="data" id="data" style="width:386px;height:178px;"></textarea><script type="text/javascript">$(function(){$("#data").formValidator({onshow:"';echo L('please_enter_a_sql');echo '",onfocus:"';echo L('please_enter_a_sql');echo '"}).inputValidator({min:1, onerror:\'';echo L('please_enter_a_sql');echo '\'});});</script></td>
  </tr>
  <tr>
		<th valign="top">';echo L('over_dbsource');echo '£º</th>
		<td class="y-bg">';echo form::select($dbsource,$db_source,'name="dbsource" id="dbsource" ');echo '<script type="text/javascript">$(function(){$("#dbsource").formValidator({onshow:"';echo L('please_select_dbsource');echo '",onfocus:"';echo L('please_select_dbsource');echo '"}).inputValidator({min:1, onerror:\'';echo L('please_select_dbsource');echo '\'});});</script></td>
  </tr>
  ';else :;echo '  <tr>
		<th valign="top">';echo L('block').L('name');echo '£º</th>
		<td class="y-bg"><input type="text" name="block" size="25" id="block"><script type="text/javascript">$(function(){$("#block").formValidator({onshow:"';echo L('please_input_block_name');echo '",onfocus:"';echo L('please_input_block_name');echo '"}).inputValidator({min:1, onerror:\'';echo L('please_input_block_name');echo '\'});});</script></td>
  </tr>
  ';endif;;echo '</table>
</fieldset>
<div class="bk15"></div>
<fieldset>
	...
	<tr>
		...
		<td class="y-bg"><input type="text" name="page" value="" id=\'page\'/> ';echo L('common_variables');echo ':<a href="javascript:void(0);" onclick="javascript:$(\'#page\').val(\'$_GET[page]\');"><font color="red">$_GET[page]</font></a>¡¢<a href="javascript:void(0);" onclick="javascript:$(\'#page\').val(\'$page\');"><font color="red">$page</font></a>£¬';echo L('no_input_no_page');echo '</td>
	</tr>
    <tr>
