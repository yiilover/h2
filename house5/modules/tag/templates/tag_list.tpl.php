...
<input type="hidden" name="s" value="tag/tag/del" />
...
<td align="center"><a href="javascript:edit(';echo $v['id'];echo ', \'';echo htmlspecialchars(new_addslashes($v['name']));echo '\')">';echo L('edit');echo '</a> | <a href="?s=tag/tag/del&id=';echo $v['id'];echo '" onclick="return confirm(\'';echo htmlspecialchars(new_addslashes(L('confirm',array('message'=>$v['name']))));echo '\')">';echo L('delete');echo '</a></td>
</tr>
';
endforeach;
endif;
...
function edit(id, name) {
	...
	window.top.art.dialog({title:\'';echo L('editing_data_sources_call');echo '¡¶\'+name+\'¡·\',id:\'edit\',iframe:\'?s=tag/tag/edit&id=\'+id,width:\'700\',height:\'500\'}, function(){var d = window.top.art.dialog({id:\'edit\'}).data.iframe;d.document.getElementById(\'dosubmit\').click();return false;}, function(){window.top.art.dialog({id:\'edit\'}).close()});
}
