...
include $this->admin_tpl('header','admin');;echo '';if(ROUTE_A=='manage') {;echo '<form name="myform" action="?s=member/member_menu/listorder" method="post">
<div class="pad-lr-10">
...
<!--
	$(function(){
		...
		$("#language").formValidator({onshow:"';echo L("input",'','admin').L('chinese_name');echo '",onfocus:"';echo L("input").L('chinese_name');echo '",oncorrect:"';echo L('input_right');;echo '"}).inputValidator({min:1,onerror:"';echo L("input").L('chinese_name');echo '"});
...
<form name="myform" id="myform" action="?s=member/member_menu/add" method="post">
...
';if(!isset($_GET['isurl']) ||(isset($_GET['isurl']) &&$_GET['isurl']==0)) {;echo '	<tr>
...
';};echo '	<tr>
	...
	<tr>
        <th>';echo L('isurl');echo '£º</th>
        <td><input type="radio" name="info[isurl]" value="1" onclick="redirect(\'';echo get_url().'&isurl=1';;echo '\')" ';if(isset($_GET['isurl']) &&$_GET['isurl']==1) echo 'checked';;echo '> ';echo L('yes');echo '<input type="radio" name="info[isurl]" value="0" ';if(!isset($_GET['isurl']) ||(isset($_GET['isurl']) &&$_GET['isurl']==0)) echo 'checked';;echo ' onclick="redirect(\'';echo get_url().'&isurl=0';;echo '\')"> ';echo L('no');echo '</td>
      </tr>
';if(isset($_GET['isurl']) &&$_GET['isurl']==1) {;echo '	<tr>
		<th>';echo L('url');echo '£º</th>
...
<div class="common-form">
<form name="myform" id="myform" action="?s=member/member_menu/edit" method="post">
<table width="100%" class="table_form contentWrap">
      <tr>
        <th width="200">';echo L('menu_parentid');echo '£º</th>
...
';};echo '	<tr>
	...
	<tr>
        <th>';echo L('isurl');echo '£º</th>
        <td>
		';if($isurl) {;echo '			<input type="radio" name="info[isurl]" value="1" checked> ';echo L('yes');echo '		';}else {;echo '			<input type="radio" name="info[isurl]" value="0" checked> ';echo L('no');echo '		';};echo '		</td>
      </tr>
';if((isset($_GET['isurl']) &&$_GET['isurl']==1) ||$isurl) {;echo '	<tr>
		<th>';echo L('url');echo '£º</th>
		<td><input type="text" name="info[url]" class="input-text" size=80 value="';echo $url;echo '"></td>
	</tr>
';};echo '</table>
<!--table_form_off-->
</div>
