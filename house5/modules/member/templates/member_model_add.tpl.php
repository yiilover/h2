...
<form name="myform" action="?s=member/member_model/add" method="post" id="myform" enctype="multipart/form-data">
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			<td>';echo L('model_import');echo '</td>
			<td>
			<input type="file" name="model_import" value="" class="input-text" id="model_import"></input>';echo L('create_new_model_can_empty');echo '			</td>
		</tr>
	</table>
</fieldset>
    <div class="bk15"></div>
