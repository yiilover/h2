...
<form name="myform" id="myform" action="?s=member/member_group/delete" method="post" onsubmit="check();return false;">
<div class="pad-lr-10">
...
;echo '    <tr>
		<td align="left">';if(!$v['issystem']) {;echo '<input type="checkbox" value="';echo $v['groupid'];echo '" name="groupid[]">';};echo '</td>
		<td align="left">';echo $v['groupid'];echo '</td>
		<td align="center"><input type="text" name="sort[';echo $v['groupid'];echo ']" class="input-text" size="1" value="';echo $v['sort'];echo '"></th>
		...
		<td align="center"><a href="javascript:edit(';echo $v['groupid'];echo ', \'';echo $v['name'];echo '\')">[';echo L('edit');echo ']</a></td>
    </tr>
';
}
;echo '</tbody>
...
<input type="submit" class="button" name="dosubmit" onclick="document.myform.action=\'?s=member/member_group/sort\'" value="';echo L('sort');echo '"/>
</div> 
...
function edit(id, name) {
	...
	window.top.art.dialog({title:\'';echo L('edit').L('member_group');echo '¡¶\'+name+\'¡·\',id:\'edit\',iframe:\'?s=member/member_group/edit&groupid=\'+id,width:\'700\',height:\'500\'}, function(){var d = window.top.art.dialog({id:\'edit\'}).data.iframe;d.document.getElementById(\'dosubmit\').click();return false;}, function(){window.top.art.dialog({id:\'edit\'}).close()});
}

function check() {
	if(myform.action == \'?s=member/member_group/delete\') {
		var ids=\'\';
