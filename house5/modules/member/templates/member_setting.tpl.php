...
<form name="myform" action="?s=member/member_setting/manage" method="post" id="myform">
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<td>
				<input type="text" name="info[refresh_times]" id="refresh_times" class="input-text" size="4" value="';echo $member_setting['refresh_times'];;echo '">
			</td>
		</tr>
		<tr>
			<td width="200">标签房源有效期</td> 
			<td>
				<input type="text" name="info[tags_valid]" id="tags_valid" class="input-text" size="4" value="';echo $member_setting['tags_valid'];;echo '"> （0为不限制）
			</td>
		</tr>
		<tr>
			<td width="200">房源默认过期时间</td> 
			<td>
				<input type="text" name="info[overtime]" id="overtime" class="input-text" size="4" value="';echo $member_setting['overtime'];;echo '"> （0为不限制）
			</td>
		</tr>
		<tr>
