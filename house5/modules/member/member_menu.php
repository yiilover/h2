...
parent::__construct();
$this->db = h5_base::load_model('member_menu_model');
}
function manage() {
...
$r['str_manage'] = '<a href="?s=member/member_menu/edit/id/'.$r['id'].'/menuid/'.$_GET['menuid'].'">'.L('edit').'</a> | <a href="javascript:confirmurl(\'?s=member/member_menu/delete/id/'.$r['id'].'/menuid/'.$_GET['menuid'].'\',\''.L('confirm',array('message'=>$r['cname'])).'\')">'.L('delete').'</a> ';
$array[] = $r;
}
$str  = "<tr>
...
$file = H5_PATH.'languages'.DIRECTORY_SEPARATOR.'zh-cn'.DIRECTORY_SEPARATOR.'member_menu.lang.php';
if(file_exists($file)) {
