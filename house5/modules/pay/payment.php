...
$this->modules_path = H5_PATH.'modules'.DIRECTORY_SEPARATOR.'pay';
h5_base::load_app_class('pay_method','','0');
...
showmessage(L('delete_succ'),'?s=pay/payment');
}
...
$receipts = h5_base::load_app_class('receipts');
...
$spend = h5_base::load_app_class('spend');
$func = $_POST['pay_type'] == '1'?'amount':'point';
...
showmessage(L('delete_succ'),'?s=pay/payment/pay_list&menuid='.$_GET['menuid']);
}
...
showmessage(L('check_passed'),'?s=pay/payment/pay_list');
}
