...
<input type="hidden" name="s" value="block/block_admin/public_search_content">
<table width="100%" class="table_form">
		<tr>
			<td width="80">';echo L('category');echo ':</td> 
			<td>';if(isset($_GET['dosubmit'])){;echo '<div class="rt"><a href="javascript:void(0)" onclick="$(\'#search\').toggle()">';echo L('folded_up_in_search_of');echo '</a></div>';}echo form::select_category('category_content_'.$this->siteid,$catid,'name="catid" id="catid"','','','0',1);echo ' </td>
		</tr>
