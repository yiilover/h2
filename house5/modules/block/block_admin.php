...
$this->db = h5_base::load_model('block_model');
$this->priv_db = h5_base::load_model('block_priv_model');
$this->history_db = h5_base::load_model('block_history_model');
...
showmessage(L('operation_success'),'?s=block/block_admin/block_update/id/'.$id);
}else {
...
if ($template) {
$block = h5_base::load_app_class('block_tag');
