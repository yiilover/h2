...
<form action="?s=admin/urlrule/edit" method="post" name="myform" id="myform">
	<tr> 
      <th width="20%">';echo L('urlrule_file');echo ' :</th>
      <td><input type="text" name="info[file]" id="file" size="20" value="';echo $file;;echo '"></td>
    </tr>
	<tr> 
      <th width="20%">';echo L('urlrule_module');echo ' :</th>
      <td>';echo form::select($modules,$module,"name='info[module]' id='module'");;echo '</td>
    </tr>
	<tr> 
      <th width="20%">';echo L('urlrule_ishtml');echo ' :</th>
      <td>
	   <input type="radio" value="1" name="info[ishtml]" ';if($ishtml) echo 'checked';;echo '/>';echo L('yes');;echo '        <input type="radio" value="0" name="info[ishtml]" ';if(!$ishtml) echo 'checked';;echo '/>';echo L('no');;echo '	</td>
    </tr>
	<tr> 
      <th width="20%">';echo L('urlrule_example');echo ' :</th>
       <td><input type="text" name="info[example]" id="example" size="70" value="';echo $example;;echo '"></td>
    </tr>
	<tr> 
      <th width="20%">';echo L('urlrule_url');echo ' :</th>
       <td><input type="text" name="info[urlrule]" id="urlrule" value="';echo $urlrule;;echo '" size="70">
	</td>
    </tr>
	<tr> 
...
';echo L('year');;echo '£º<input type="text" name="f1" value="{$year}" size="7" class="input-botton"> ';echo L('month');;echo '£º<input type="text" name="f1" value="{$month}" size="9" class="input-botton">£¬';echo L('day');;echo '£º<input type="text" name="f1" value="{$day}" size="7" class="input-botton"> ID£º<input type="text" name="f1" value="{$id}" size="4" class="input-botton">£¬ ';echo L('paging');;echo '£º<input type="text" name="f1" value="{$page}" size="7" class="input-botton">
		...
		<input type="hidden" name="urlruleid" id="urlruleid" value="';echo $urlruleid;;echo '">
