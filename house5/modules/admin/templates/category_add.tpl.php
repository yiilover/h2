...
<table width="100%" class="table_form ">
 <tr>
     <th>';echo L('add_category_types');;echo '£º</th>
      <td>
	  ...
	  <input type=\'radio\' name=\'addtype\' value=\'1\'  onclick="$(\'#catdir_tr\').html(\' \');$(\'#normal_add\').html(\' \');$(\'#normal_add\').css(\'display\',\'none\');$(\'#batch_add\').css(\'display\',\'\');$(\'#normal_addid\').attr(\'disabled\',\'true\');this.disabled=\'true\'"> ';echo L('batch_add');;echo '</td>
		...
		<tr>
        <th width="200">';echo L('select_model');echo '£º</th>
        <td>
		 ';
$model_datas = array();
...
<table width="100%" class="table_form ">
	...
	<tr>
      <th>';echo L('category_urlrules');;echo '£º</th>
...
;echo '	</div>
	...
	<tr>
      <th>';echo L('show_urlrules');;echo '£º</th>
...
<tr>
      <th>';echo L('create_to_rootdir');;echo '£º</th>
      <td>
