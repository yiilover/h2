...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td class="tpl_style"><b>';echo L('category_index_tpl');echo '£º</b><br>
...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td class="tpl_style"><b>';echo L('category_list_tpl');echo '£º</b><br>
...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td class="tpl_style"><b>';echo L('content_tpl');echo '£º</b><br>
...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td><b>';echo L('workflow');echo '£º</b><br>';echo form::select($workflows_datas,$cat['setting']['workflowid'],'name="setting['.$catid.'][workflowid]"',L('catgory_not_need_check'));;echo '</td>
	';
}
;echo '	 </tr>
	<tr>
...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td><b>';echo L('html_show');echo '£º</b><br>
...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td><b>';echo L('show_urlrules');echo '£º</b><br>
...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td><b>';echo L('create_to_rootdir');echo '£º</b><br>
...
;echo '	 </tr>
	<tr>
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td><b>';echo L('contribute_add_point');echo '£º</b><br>
...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td><b>';echo L('default_readpoint');echo '£º</b><br>
...
;echo '	 </tr>
	 ...
	 ';
foreach($batch_array as $catid=>$cat) {
;echo '		<td><b>';echo L('repeatchargedays');echo '£º</b><br>
