...
<form name="searchform" id="searchform" action="?s=admin/ipbanned/search_ip&menuid=';echo $_GET['menuid'];;echo '" method="get"  >
<input type="hidden" value="admin/ipbanned/search_ip" name="s">
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		<tr>
		<td><div class="explain-col">IP:  <input type="text" value="" class="input-text" id="ip" name="search[ip]">    <input type="submit" value="';echo L('search');echo '" class="button" name="dosubmit">
		</div>
		</td>
		</tr>
    </tbody>
...
;echo '    <tr>
	...
	<input type="checkbox" name="ipbannedid[]" value="';echo $info['ipbannedid'];echo '">
        ...
        <td align="center">';echo date('Y-m-d',$info['expires']);;echo '</td>
         <td align="center"><a href="javascript:confirmurl(\'?s=admin/ipbanned/delete&ipbannedid=';echo $info['ipbannedid'];echo '\', \'';echo L('confirm',array('message'=>L('selected')));echo '\')">';echo L('delete');echo '</a> </td>
    </tr>
';
}
}
...
function checkSubmit()
{
	...
	{
		searchform.ip.focus();
		alert("';echo L('parameters_error');echo '");
		return false;
	}
	else
	{
		...
		{
			searchform.ip.focus();
			alert("';echo L('ip_type_error');echo '");
			return false;
		}
		else
		{
