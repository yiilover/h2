...
$this->db_data = h5_base::load_model('position_data_model');
...
$pages = $this->db->pages;
$show_dialog = true;
$big_menu = array('javascript:window.top.art.dialog({id:\'add\',iframe:\'?s=admin/position/add\', title:\''.L('posid_add').'\', width:\'500\', height:\'360\', lock:true}, function(){var d = window.top.art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'add\'}).close()});void(0);',L('posid_add'));
...
$this->sitemodel_db = h5_base::load_model('sitemodel_model');
...
$this->_set_cache();
showmessage(L('posid_del_success'),'?s=admin/position/init');
}
...
$this->_set_cache();
showmessage(L('operation_success'),'?s=admin/position/init');
}else {
showmessage(L('operation_failure'),'?s=admin/position/init');
}
}
...
$big_menu = array('javascript:window.top.art.dialog({id:\'add\',iframe:\'?s=admin/position/add\', title:\''.L('posid_add').'\', width:\'500\', height:\'300\', lock:true}, function(){var d = window.top.art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'add\'}).close()});void(0);',L('posid_add'));
