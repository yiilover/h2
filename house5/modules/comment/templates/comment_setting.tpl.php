...
;echo '
<div class="pad-10">
<form action="?s=comment/comment_admin/init" method="post" id="myform">
<fieldset>
	<legend>';echo L('comments_module_configuration');echo '</legend>
  ...
  <tr>
    <th width="120">';echo L('comments_on_points_awards');echo '£º</th>
