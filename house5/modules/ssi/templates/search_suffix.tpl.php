...
<input type="hidden" name="a" value="public_search_suffix">
...
<!--
	...
	$("input[type=\'checkbox\'][name=\'ids[]\']:checked").each(function(i,n){parent.insert_forms_suffix(';echo $_GET['contentid'];;echo ',$(n).val());});
	parent.art.dialog({id:\'search_suffix\'}).close();
}
//-->
</script>
</body>
