...
<div class="pad-10">
<form action="?s=ssi/ssi/add" method="post" id="myform">
<div>
<fieldset>
	...
	<table width="100%"  class="table_form">
      <tr>
            ...
            <td class="y-bg"><input type="text" name="name" size="25" id="name"><script type="text/javascript">$(function(){$("#name").formValidator({onshow:"';echo L('please_input_block_name');echo '",onfocus:"';echo L('please_input_block_name');echo '"}).inputValidator({min:1, onerror:\'';echo L('please_input_block_name');echo '\'});});</script></td>
      </tr>
    ...
    <tr>
		...
		<td class="y-bg"><textarea name="data" id="data" style="width:386px;height:178px;"></textarea></td>
  </tr>
