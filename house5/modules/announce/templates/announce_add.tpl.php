...
?>
<div class="pad-10">
<form method="post" action="?s=announce/admin_announce/add" name="myform" id="myform">
...
<tbody>
	...
	<tr>
		...
		<td id="show_template"><script type="text/javascript">$.getJSON('?s=admin/category/public_tpl_file_list/style/<?php echo $info['default_style']?>/module/announce/templates/show/name/announce/h5_hash/'+h5_hash, function(data){$('#show_template').html(data.show_template);});</script></td>
	</tr>
	<tr>
...
$(document).ready(function(){
	...
	$('#title').formValidator({onshow:"<?php echo L('input_announce_title')?>",onfocus:"<?php echo L('title_min_3_chars')?>",oncorrect:"<?php echo L('right')?>"}).inputValidator({min:1,onerror:"<?php echo L('title_cannot_empty')?>"}).ajaxValidator({type:"get",url:"",data:"s=announce/admin_announce/public_check_title",datatype:"html",cached:false,async:'true',success : function(data) {
        if( data == "1" )
		{
            return true;
		}
