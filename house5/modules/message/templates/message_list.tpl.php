...
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		<tr>
		<td><div class="explain-col">';echo L('query_type');echo ':';echo form::select($trade_status,$status,'name="search[status]"',L('all'));echo '      ';echo L('username');echo ':  <input type="text" value="" class="input-text" name="search[username]">  ';echo L('time');echo ':  ';echo form::date('search[start_time]','','');echo ' ';echo L('to');echo '   ';echo form::date('search[end_time]','','');echo '    <input type="submit" value="';echo L('search');echo '" class="button" name="dosubmit">
		</div>
		</td>
		</tr>
    </tbody>
