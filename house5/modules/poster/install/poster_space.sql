DROP TABLE IF EXISTS `house5_poster_space`;
CREATE TABLE IF NOT EXISTS `house5_poster_space` (
...
INSERT INTO `house5_poster_space` (`siteid`, `spaceid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
