...
<!--
	$(function(){
		...
		$("#name").formValidator({onshow:"';echo L('input').L('name');echo '",onfocus:"';echo L('input').L('name');echo '"}).inputValidator({min:1,onerror:"';echo L('input').L('name');echo '"}).ajaxValidator({type : "get",url : "",data :"s=dbsource&c=data&a=public_name",datatype : "html",async:\'false\',success : function(data){	if( data == "1" ){return true;}else{return false;}},buttons: $("#dosubmit"),onerror : "';echo L('name').L('exists');echo '",onwait : "';echo L('connecting');echo '"});
...
<div class="pad-10">
<form action="?s=dbsource/data/add" method="post" id="myform">
<div>
<fieldset>
...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg">';echo form::radio(array('1'=>'json','2'=>'xml','3'=>'js'),'1','name="dis_type" onclick="showcode(this.value)"');echo '</td>
  </tr>
