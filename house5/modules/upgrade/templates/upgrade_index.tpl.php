...
<input name="s" value="upgrade/index/init/s/1" type="hidden" />
...
<tbody>
    <tr>
		<td align="left"><?php echo $current_version['h5_version'];?></td>
		<td align="left"><?php echo $current_version['h5_release'];?></td>
    </tr>
...
<thead>
	<tr>
		...
		<th align="left" width="100"><?php echo L('updatetime')?></th>
		<th align="left">Éý¼¶ËµÃ÷</th>
	</tr>
</thead>
<tbody>
	<?php foreach($pathlist as $k=>$v) { ?>
	<tr>
		<td><?php echo $v;?></td>
		<td><?php echo substr($v, 15, 8);?></td>
		<td><?php echo $desc[$k];?></td>
	</tr>
	<?php }?>
</tbody>
</table>
