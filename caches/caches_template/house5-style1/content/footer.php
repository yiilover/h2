<?php defined('IN_HOUSE5') or exit('No permission resources.'); ?><SCRIPT type=text/javascript src="<?php echo APP_PATH;?>statics/house5-style1/js/index/scrolltop.js"></SCRIPT>
<style>
...
.gg_full .gg_fbtn A {
	DISPLAY: block; BACKGROUND: url(/statics/house5-style1/img/index/gg_btn.png) no-repeat 0px 0px; HEIGHT: 55px; OVERFLOW: hidden
}
.gg_full .gg_fbtn .gg_fclose {
	BACKGROUND: url(/statics/house5-style1/img/index/gg_btn.png) no-repeat -19px 0px
}
.gg_full .gg_fcon {
...
<DIV style="DISPLAY: none" id=goTopBtn><IMG border=0 src="<?php echo APP_PATH;?>statics/house5-style1/img/index/lanren_top.jpg"></DIV>
...
<br />
<?php echo $copyright;?> <img src="<?php echo APP_PATH;?>statics/house5-style1/img/index/copyright.gif"/>
</div>
<br /><br />
<img src="<?php echo APP_PATH;?>statics/house5-style1/img/index/beian.gif" width="120" height="50"  style="display: inline; ">&nbsp;<img src="<?php echo APP_PATH;?>statics/house5-style1/img/index/baojing.gif" width="120" height="50" style="display: inline; ">&nbsp;<img src="<?php echo APP_PATH;?>statics/house5-style1/img/index/jubao.gif" width="120" height="50" style="display: inline; ">
</div>
</div>
</center>
