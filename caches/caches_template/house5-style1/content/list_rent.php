...
seajs.use("topbarlogin")
	...
	<div id="Search">
		<ul class="searchURL">
			...
			<li class="on"><a href="<?php echo ESF_PATH;?>rent-list.html"  target="_blank">出租房</a></li>
		...
		<a href="<?php echo ESF_PATH;?>rent-map.html"  class="mapS" target="_blank">地图找房</a>
<?php
$param = $_GET['param'];
...
<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
		...
		<div data-k = "万" id="jg" data-val="<?php if(!empty($eprice)) { ?>-e<?php echo $eprice;?><?php } ?>">
			...
			<div>
				<a data-val="" href="javascript:void(0)">全部</a>
											<a <?php if($range=="1") { ?> class="on"<?php } ?> href="javascript:void(0)" data-val="-p1">600元以下</a>
											<a <?php if($range=="3") { ?> class="on"<?php } ?> href="javascript:void(0)" data-val="-p3">600-1000元</a>
											<a <?php if($range=="4") { ?> class="on"<?php } ?> href="javascript:void(0)" data-val="-p4">1000-1500元</a>
											<a <?php if($range=="5") { ?> class="on"<?php } ?> href="javascript:void(0)" data-val="-p5">1500-2000元</a>
											<a <?php if($range=="6") { ?> class="on"<?php } ?> href="javascript:void(0)" data-val="-p6">2000-2500元</a>
											<a <?php if($range=="7") { ?> class="on"<?php } ?> href="javascript:void(0)" data-val="-p7">2500-3000元</a>
											<a <?php if($range=="8") { ?> class="on"<?php } ?> href="javascript:void(0)" data-val="-p8">3000-4000元</a>
											<a <?php if($range=="9") { ?> class="on"<?php } ?> href="javascript:void(0)" data-val="-p9">4000元以上</a>
												</div>
		</div>
		<div id="shx">
...
seajs.use("jquery",function($){
	...
	$newMenu.hover(function(){
		...
		$(this).removeClass("on")
			...
			<li>
				<a href="<?php echo ESF_PATH;?>rent-map.html"  target="_blank">地图找房<em></em></a>
			</li>
			<li >
...
<script type="text/javascript">
	seajs.use(["jquery","hsearch"],function($){
		$("#Search").hSearch("rent-list","<?php echo APP_PATH;?>api.php?op=esfsuggest");
		$("#jg,#wy").each(function(){
			var $t=$(this);
			...
			<a href="<?php echo ESF_PATH;?>" ><?php echo $default_city;?>二手房网</a> &gt;
			房源列表
		</div>
		<div class="modB">
	<a href="<?php echo ESF_PATH;?>chuzu.html"  target="_blank" class="fbfr">个人免费发布房源</a>
	<ul class="modTab">
	<li class="on"><a href="<?php echo ESF_PATH;?>rent-list.html" >全部房源</a></li>
...
<div class="conl1" id="conl1">
	<div class="cf" style="padding-top:9px;">
			...
			<span>
				<a href="rent-list<?php echo deal_str($lst,'r');?>.html" <?php if(empty($parentid)) { ?>  class="c" <?php } ?>>不限</a>
<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" h5_action=\"content\" data=\"op=content&tag_md5=1169c1088f6c4950c1f4cf9ee68e7753&action=getlinkage&keyid=3360&parentid=0&order=listorder+ASC&cache=86400\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$tag_cache_name = md5(implode('&',array('keyid'=>'3360','parentid'=>'0','order'=>'listorder ASC',)).'1169c1088f6c4950c1f4cf9ee68e7753');if(!$data = tpl_cache($tag_cache_name,86400)){$content_tag = h5_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'getlinkage')) {$data = $content_tag->getlinkage(array('keyid'=>'3360','parentid'=>'0','order'=>'listorder ASC','limit'=>'20',));}if(!empty($data)){setcache($tag_cache_name, $data, 'tpl_data');}}?>
<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
<?php
 	$reg = explode('$$', $r);//add by L 2012/3/22
	...
	?>
	<a href="rent-list-r<?php echo $reg['0'];?><?php echo deal_str($lst,'r');?>.html" <?php if(!empty($parentid) && $parentid==$reg[0]) { ?> class="c"<?php } ?>><?php echo $reg['1'];?></a>
	<?php $n++;}unset($n); ?>
<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
	                			  				</span>
<?php if($parentid) { ?>
...
<?php if($data) { ?>
												<!--以下是板块信息，点击区域后才出现的-->
												<span class="i">
				<a href="rent-list<?php echo deal_str($lst,'b');?>.html" <?php if(empty($bid)) { ?> class="c"<?php } ?>>不限</a>
				<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
			<?php
				...
				?>
				               		<a href="rent-list<?php echo deal_str($lst,'b');?>-b<?php echo $reg2['0'];?>.html" <?php if(!empty($bid) && $bid==$reg2[0]) { ?> class="c"<?php } ?>><?php echo $reg2['1'];?></a>
									<?php $n++;}unset($n); ?>
               				</span>
<?php } ?>
<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
<?php } ?>
		...
		<div class="cf">
			...
			<span>
				<a <?php if(empty($range)) { ?> class="c"<?php } ?> href="rent-list<?php echo deal_str($lst,'p');?>.html" >不限</a>
				<a href="rent-list<?php echo deal_str($lst,'p');?>-p1.html" <?php if($range=="1") { ?> class="c"<?php } ?>>600以下</a>     
				<a href="rent-list<?php echo deal_str($lst,'p');?>-p3.html" <?php if($range=="3") { ?> class="c"<?php } ?>>600-1000元</a>  
				<a href="rent-list<?php echo deal_str($lst,'p');?>-p4.html" <?php if($range=="4") { ?> class="c"<?php } ?>>1000-1500元</a>  
				<a href="rent-list<?php echo deal_str($lst,'p');?>-p5.html" <?php if($range=="5") { ?> class="c"<?php } ?>>1500-2000元</a> 
				<a href="rent-list<?php echo deal_str($lst,'p');?>-p6.html" <?php if($range=="6") { ?> class="c"<?php } ?>>2000-2500元</a>
				<a href="rent-list<?php echo deal_str($lst,'p');?>-p7.html" <?php if($range=="7") { ?> class="c"<?php } ?>>2500-3000元</a>
				<a href="rent-list<?php echo deal_str($lst,'p');?>-p8.html" <?php if($range=="8") { ?> class="c"<?php } ?>>3000-4000元</a>
				<a href="rent-list<?php echo deal_str($lst,'p');?>-p9.html" <?php if($range=="9") { ?> class="c"<?php } ?>>4000以上</a>    
				<?php
			if(!empty($range_name))
				{
			...
			?>
              										<div class="autoF">
					<form action="rent-list<?php echo deal_str($lst,'p');?>-e" method="get">
						<input type="text" value="<?php echo $minprice;?>"> - 
						<input type="text" value="<?php echo $maxprice;?>"> 元
		...
		<div class="cf">
			...
			<span>
				<a href="rent-list<?php echo deal_str($lst,'c');?>.html" <?php if(empty($area)) { ?> class="c"<?php } ?>  >不限</a>
							   	               	<a href="rent-list<?php echo deal_str($lst,'c');?>-c1.html" <?php if($area=="1") { ?> class="c"<?php } ?>>70平米以下</a> 
               	               	<a href="rent-list<?php echo deal_str($lst,'c');?>-c3.html" <?php if($area=="3") { ?> class="c"<?php } ?>>70-90平米</a> 
               	               	<a href="rent-list<?php echo deal_str($lst,'c');?>-c4.html" <?php if($area=="4") { ?> class="c"<?php } ?>>90-120平米</a> 
               	               	<a href="rent-list<?php echo deal_str($lst,'c');?>-c5.html" <?php if($area=="5") { ?> class="c"<?php } ?>>120-150平米</a> 
               	               	<a href="rent-list<?php echo deal_str($lst,'c');?>-c6.html" <?php if($area=="6") { ?> class="c"<?php } ?>>150-200平米</a> 
               	               	<a href="rent-list<?php echo deal_str($lst,'c');?>-c7.html" <?php if($area=="7") { ?> class="c"<?php } ?>>200-300平米</a> 
               	               	<a href="rent-list<?php echo deal_str($lst,'c');?>-c8.html" <?php if($area=="8") { ?> class="c"<?php } ?>>300平米以上</a> 
					<?php
			if(!empty($area_name))
				{
			...
			?>
               				   				   	<div class="autoF">
					<form action="rent-list<?php echo deal_str($lst,'c');?>-m" method="get">
		...
		<div class="cf">
			...
			<span>
				<a href="rent-list<?php echo deal_str($lst,'t');?>.html"  <?php if(empty($type)) { ?> class="c" <?php } ?>>不限</a>
							   	    <a href="rent-list<?php echo deal_str($lst,'t');?>-t1.html" <?php if($type=="1") { ?> class="c" <?php } ?>>一室</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'t');?>-t2.html" <?php if($type=="2") { ?> class="c" <?php } ?>>二室</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'t');?>-t3.html" <?php if($type=="3") { ?> class="c" <?php } ?>>三室</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'t');?>-t4.html" <?php if($type=="4") { ?> class="c" <?php } ?>>四室</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'t');?>-t5.html" <?php if($type=="5") { ?> class="c" <?php } ?>>其它</a> 
               				   				</span>
					<?php
			if(!empty($type))
				{
		...
		<div class="cf">
			...
			<span>
				<a href="rent-list<?php echo deal_str($lst,'u');?>.html" <?php if(empty($source)) { ?> class="c" <?php } ?>>不限</a> 
				<a href="rent-list<?php echo deal_str($lst,'u');?>-u2.html" <?php if($source=="2") { ?> class="c" <?php } ?>>中介</a> 
				<a href="rent-list<?php echo deal_str($lst,'u');?>-u1.html" <?php if($source=="1") { ?> class="c" <?php } ?>>个人</a> 
			</span>
				<?php
			if(!empty($source))
				{
		...
		<div class="cf">
			...
			<span>
				<a href="rent-list<?php echo deal_str($lst,'l');?>.html" <?php if(empty($rent_type)) { ?> class="c" <?php } ?>>不限</a>
				                    <a href="rent-list<?php echo deal_str($lst,'l');?>-l1.html" <?php if($rent_type=="1") { ?> class="c" <?php } ?>>整租</a>
                                	<a href="rent-list<?php echo deal_str($lst,'l');?>-l2.html" <?php if($rent_type=="2") { ?> class="c" <?php } ?>>合租</a>
                                	<a href="rent-list<?php echo deal_str($lst,'l');?>-l3.html" <?php if($rent_type=="3") { ?> class="c" <?php } ?>>日租</a>
                                			</span>
			<?php
			if(!empty($rent_type))
				{
		...
		<div class="cf">
			...
			<span>
				<a href="rent-list<?php echo deal_str($lst,'f');?>.html" <?php if(empty($fix)) { ?> class="c" <?php } ?>>不限</a>
							   		<a href="rent-list<?php echo deal_str($lst,'f');?>-f1.html" <?php if($fix=="1") { ?> class="c" <?php } ?>>毛坯</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'f');?>-f2.html" <?php if($fix=="2") { ?> class="c" <?php } ?>>精装</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'f');?>-f3.html" <?php if($fix=="3") { ?> class="c" <?php } ?>>中等装修</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'f');?>-f4.html" <?php if($fix=="4") { ?> class="c" <?php } ?>>简装</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'f');?>-f5.html" <?php if($fix=="5") { ?> class="c" <?php } ?>>豪华装修</a> 
               	               		<a href="rent-list<?php echo deal_str($lst,'f');?>-f6.html" <?php if($fix=="6") { ?> class="c" <?php } ?>>原房</a> 
               				   				</span>
			<?php
			if(!empty($fix))
				{
		...
		<div class="cf">
			...
			<span>
					<a href="rent-list<?php echo deal_str($lst,'o');?>.html"  <?php if(empty($opentime)) { ?> class="c" <?php } ?>>不限</a> 
					<a href="rent-list<?php echo deal_str($lst,'o');?>-o2.html" <?php if($opentime=="2") { ?> class="c" <?php } ?> >3天内发布</a>
					<a href="rent-list<?php echo deal_str($lst,'o');?>-o3.html" <?php if($opentime=="3") { ?>  class="c" <?php } ?>>7天内发布</a>
					<a href="rent-list<?php echo deal_str($lst,'o');?>-o4.html" <?php if($opentime=="4") { ?>  class="c" <?php } ?>>15天内发布</a>
					<a href="rent-list<?php echo deal_str($lst,'o');?>-o5.html" <?php if($opentime=="5") { ?>  class="c" <?php } ?>>30天内发布</a>
					</span>
			<?php
			if(!empty($opentime))
				{
		...
		<div class="cf b">
			...
			<div class="w720 fl">
				<div class="Tle cf">
					<div class="fl">
						<a <?php if(empty($hot)) { ?> class="A"<?php } else { ?> class="B"<?php } ?> href="rent-list.html" >全部房源</a>
	                	<a <?php if($hot=="1") { ?> class="A"<?php } else { ?> class="B"<?php } ?> href="rent-list<?php echo deal_str($lst,'u');?>-h1.html" >新推房源</a>
	                	<a <?php if($hot=="3") { ?> class="A"<?php } else { ?> class="B"<?php } ?> href="rent-list<?php echo deal_str($lst,'u');?>-h3.html" >急售房源</a>
	                	<a <?php if($hot=="2") { ?> class="A"<?php } else { ?> class="B"<?php } ?> href="rent-list<?php echo deal_str($lst,'u');?>-h2.html" >推荐房源</a>
						<a <?php if($hot=="4") { ?> class="A"<?php } else { ?> class="B"<?php } ?> href="rent-list<?php echo deal_str($lst,'u');?>-h4.html" >多图房源</a>
	                	<a <?php if($source=="1") { ?> class="D"<?php } else { ?> class="C"<?php } ?> href="rent-list<?php echo deal_str($lst,'u');?>-u1.html" >个人</a>
					</div>
					<div class="tel_page fr">
						<span>
							共找到 <strong class="red" id="num"></strong>条房源
						</span>
						<a class="pre" href="rent-list<?php echo deal_str($lst,'g');?>-g1.html" ></a>
						<span class="num">1</span>
						<a class="next" href="rent-list<?php echo deal_str($lst,'g');?>-g2.html" >下一页</a>
					</div>
				</div>
				<div class="Tle2">
					<form action="<?php echo ESF_PATH;?>rent-list-search" method="post">
					...
					<div class="TelIcon fr">
						<a href="<?php if($ord==2) { ?>rent-list<?php echo deal_str($lst,'n');?>-n3.html<?php } else { ?>rent-list<?php echo deal_str($lst,'n');?>-n2.html<?php } ?>"  class="A1 <?php if($ord==2) { ?>down<?php } ?><?php if($ord==3) { ?>up<?php } ?>">面积</a>
						<a href="<?php if($ord==6) { ?>rent-list<?php echo deal_str($lst,'n');?>-n7.html<?php } else { ?>rent-list<?php echo deal_str($lst,'n');?>-n6.html<?php } ?>"  class="A1 <?php if($ord==6) { ?>down<?php } ?><?php if($ord==7) { ?>up<?php } ?>">租金</a>
					...
					<div class="s_list fr" id="s_list1">
						...
						<ul>
							<li>
								<a href="rent-list<?php echo deal_str($lst,'n');?>-n2.html" >面积从大到小</a>
							</li>
							<li>
								<a href="rent-list<?php echo deal_str($lst,'n');?>-n3.html" >面积从小到大</a>
							</li>
							<li>
								<a href="rent-list<?php echo deal_str($lst,'n');?>-n6.html" >租金从高到低</a>
							</li>
							<li>
								<a href="rent-list<?php echo deal_str($lst,'n');?>-n7.html" >租金从低到高</a>
							</li>
						</ul>
					</div>
				</div>
...
<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" h5_action=\"content\" data=\"op=content&tag_md5=23f679dea3b13baa52bd938cc747055c&action=lists&catid=%24catid&where=%24where&num=10&lst=%24lst&order=%24order&page=%24page&moreinfo=1&cache=10800\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = h5_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 10;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('catid'=>$catid,'where'=>$where,'lst'=>$lst,'order'=>$order,'moreinfo'=>'1','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$housepages = housepages($content_total, $page, $pagesize, $urlrule,$lst);$mobilepages = mobilepages($content_total, $page, $pagesize, $urlrule,$keyword);$data = $content_tag->lists(array('catid'=>$catid,'where'=>$where,'lst'=>$lst,'order'=>$order,'moreinfo'=>'1','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?><!-- 楼盘列表 -->
	...
	<?php $pic_num = count(string2array($r[house_pic]))+count(string2array($r[house_room]))+count(string2array($r[house_outdoor]))?>
			<tr>
			<td class="pic">
				<a href="<?php echo ESF_PATH;?>rent-show-<?php echo $r['id'];?>.html"  title="<?php echo $r['title'];?>" target="_blank">
			...
			<td class="info">
				<h5>
					<a href="<?php echo ESF_PATH;?>rent-show-<?php echo $r['id'];?>.html"  title="<?php echo $r['title'];?>" target="_blank"><?php echo $r['title'];?></a>
				...
				<p>
					...
					<?php echo $r['huxingshi'];?>室<?php echo $r['huxingting'];?>厅					<?php echo $r['total_area'];?>平米
					<?php echo getbox_val('41','fix',$r['fix']);?>					<?php if($r[rent_type]==1) { ?>整租<?php } elseif ($r[rent_type]==2) { ?>合租<?php } else { ?>日租<?php } ?>					楼层：<?php echo $r['floor'];?>/<?php echo $r['zonglouceng'];?>					<br>
			...
			<td class="price">
				<strong><?php echo $r['price'];?>元/月</strong>
			</td>
			<td class=""> </td>	
		</tr>
	<?php $n++;}unset($n); ?>
...
<?php if($prowhere) { ?>
	...
	<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
		<?php $relationxq = get_relationxq($r[id],$catid,110)?>
				<li>
			<span class="lettsub7"><a href="<?php echo ESF_PATH;?>rent-show-<?php echo $r['id'];?>.html" title="<?php echo $r['title'];?>" target="_blank"><?php echo $relationxq['title'];?></a></span>
			<span class="w2"><?php echo $r['total_area'];?>㎡</span>
			<span class="w3"><?php echo $r['price'];?>元/月</span>
		</li>
		<?php $n++;}unset($n); ?>
		<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
			</ul>
...
<?php
 	$reg = explode('$$', $r);//add by L 2012/3/22
	?>			
						<a href="rent-list-r<?php echo $reg['0'];?>.html"  target="_blank"><?php echo $reg['1'];?></a>						
	<?php $n++;}unset($n); ?>
<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
					</p>
			</div>
