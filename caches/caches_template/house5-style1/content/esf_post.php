...
<script type="text/javascript" src="<?php echo APP_PATH;?>statics/default/js/esf/validor_sell_zhijia.js" ></script>
...
<div id="wrap">
   ...
   <?php include template("ssi","ssi_8"); ?>
    ...
    <div class="mt10 login_header">
        ...
        <ul class="nav">
        	<li class="nav2"><a href="<?php echo ESF_PATH;?>chuzu.html" ></a><a href="<?php echo ESF_PATH;?>chushou.html" ></a></li>
        </ul>
        <div class="clear"></div>
    </div>
    <!--导航结束-->
...
<form id="myform" method="post" action="<?php echo APP_PATH;?>index.php?s=content/index/esf_save" >
<table width="960" border="0" cellspacing="0" cellpadding="0" class="tabSty" >
      ...
      <tr class="form_element house1">
	    ...
	    <option value=<?php echo $reg['0'];?>><?php echo $reg['1'];?></option>
			...
			<?php $n++;}unset($n); ?>
                ...
                <div class="add_bot"><strong>注意</strong>：如果创建的<font class="com_office">小区</font>叫<span class="red">环翠区莱茵小镇<font class="com_office">小区</font></span>那么请您在<font class="com_office">小区</font>名称那里填写<span class="red">莱茵小镇</span>就可以，<font class="com_office">小区</font>的名称中不可出现无关的文字和符号，如果不符合标准,您的房源信息可能会被处理为违规房源。</div>
            </div>
            <div class="clear"></div>
            <span class="gray" style="display:inline-block;">请输入<font class="com_office">小区</font>名称，如："莱茵小镇"或"lyxz"，然后在下面打开的列表中选择即可。</span>
        </td>
      </tr>
	  <tr>
      ...
      <tr>
        <th><span><em>*</em> 价格：</span></th>
        <td>
        	<div style="font-size:12px;float:left;"><input id="price" name="price" type="text" value="" style="width:100px;color:#999;" class="default_color input_bg input_border_def" maxlength="20" size="40"  autocomplete="off" >&nbsp;万</div>
