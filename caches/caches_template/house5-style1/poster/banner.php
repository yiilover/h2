<?php defined('IN_HOUSE5') or exit('No permission resources.'); ?>function PCMSAD(PID) {
  this.ID        = PID;
  this.PosID  = 0; 
  this.ADID		  = 0;
  this.ADType	  = "";
...
function statAD() {
	...
	new_element.src="<?php echo APP_PATH;?>index.php?s=poster/index/show&siteid="+this.SiteID+"&spaceid="+this.ADID+"&id="+this.PosID; 
...
cmsAD_<?php echo $spaceid;?>.URL = "<?php echo APP_PATH;?>index.php?s=poster/index"; 
