...
<meta name="description" content="楼盘电子地图，楼盘地图搜索，搜索楼盘，楼盘地图、做最好的房产地图网站，提供';echo $default_city;;echo '房产分布地图、楼市电子地图、楼盘电子地图、新房电子地图搜索，提供最新、最全、最快的';echo $default_city;;echo '新房楼盘信息查询，公寓、经济适用房、花园洋房、板楼、塔楼、板塔结合、别墅等各式楼盘电子地图。" />
...
;echo 'Price[-1]=Price[1]={unit:\'单价(元/㎡)\',text:[';echo $Price;;echo '],value:[';echo $Price;;echo ']};
</script>
...
<div class="dingbuhexin" id="topmenu">
	...
	<div class="dingbuhexindh">
		<div class="rbjl noshow"></div>
				<div class="up">新房</div>
		<div class="middle">
			<div class="line"></div><div class="down"><a href="';echo ESF_PATH;;echo 'map.html" target="_blank">二手房</a></div>								</div>
		<div class="rbj"></div> 
			</div>
	<div class="clear"></div>
</div>
...
<form id="form1" method="post" action=""  onsubmit="SFMapUI.clearAllOption();SFMap.searchKeyword();return false;">
	<div class="dingbuhexinnrl">请输入楼盘名/地址：<br/>
	...
	<input type="submit" class="but_1" value="搜索" style="vertical-align:middle;" />
...
<input type="hidden" name="sort" id="sort" />
	...
	<div class="dingbuhexinnrr">
		<div class="s1" id="purposes_a">类型： 不限&nbsp;&nbsp;<span><a href="#">住宅</a></span><span><a href="#">经济适用房</a></span><span><a href="#">别墅</a></span><span><a href="#">写字楼</a></span><span><a href="#">商铺</a></span></div>
		<div id="price_a">
			<div class="s1">价格： 不限   <span><a href="#">6千以下</a></span><span><a href="#">6千-1万</a><span></span><a href="#">1万-1.5万</a></span><span><a href="#">1.5万-2万</a></span><span><a href="#">2万-3万</a></span><span><a href="#">3万以上</a></span> 售价 (￥/㎡)
			</div>
		</div>
	</div>
	<div class="clear"></div>
	<div class="conditionsearch" id="panel_moreoptions" onmouseover="SFMapUI.showMoreOptions();" onmouseout="SFMapUI.hideMoreOptions();">
		...
		<div class="s3" id="panel_moreoptions_s3">
			<form>开盘时间：<a onclick="SFMapUI.showMenu(\'opentimesyear_a\');SFUI.setInputA(\'opentimeeyear\',\'\',\'\');return false;" id="opentimesyear_a" class="path_down" href="javascript:;"></a> 年
				<a onclick="SFMapUI.showMenu(\'opentimesmonth_a\');SFUI.setInputA(\'opentimeeyear\',\'\',\'\');return false;" id="opentimesmonth_a" class="path_down" href="javascript:;"></a> 月  - 
				<a onclick="SFMapUI.showMenu(\'opentimeeyear_a\');return false;" id="opentimeeyear_a" class="path_down" href="javascript:;"></a> 年
				<a onclick="SFMapUI.showMenu(\'opentimeemonth_a\');return false;" id="opentimeemonth_a" class="path_down" href="javascript:;"></a> 月
			<input type="button" onclick="SFMapUI.searchOpentime(event);" value="确 定" class="but_2" />
			<input type="button" onclick="SFMapUI.clearOpentime();" value="清 空" class="but_3">
			</form>
		</div>
		<div class="s2"></div>
		<div class="clear"></div>
...
<div class="pagebody">
	<div class="path">
		...
		<div class="pathl">快速定位：<span class="path_down" id="district_a" onmouseover="SFMapUI.showMenu(\'district_a\');"  onmouseout="SFUI.hideId(\'panel_district_a\');">选择区域</span>
			<span class="path_down" id="round_a" onmouseover="SFMapUI.showMenu(\'round_a\');"  onmouseout="SFUI.hideId(\'panel_round_a\');">选择环线</span>
			<span class="path_down" id="subway_a" onmouseover="SFMapUI.showMenu(\'subway_a\');"  onmouseout="SFUI.hideId(\'panel_subway_a\');">选择地铁</span></div>
		<div class="pathm">
		...
		<div class="pathm2">
						<input name="lock" type="checkbox" id="lock" onclick="SFMap.toggleDrag(this,true);//Clickstat.optClickHandler(\'lock\',this.checked);" /> <span class="mapMenuRsd" title="勾选后拖动地图不改变搜索结果">锁定搜索结果</span></div>
				<div class="clear"></div>
	</div>
	<!-- 右边内容 begin -->
	...
	<div class="inforight" id="rightmenu1">
		<div class="inforightbt">
			<ul>
				<li class="a_on">搜索结果</li>
				<li class="line"></li>
				<li class="a_off"><a href="javascript:;" onclick="SFUI.showPeer(\'listfav\');SFMap.showFavorite();">我的收藏</a></li>
			</ul>
		</div>
		<!-- 搜索结果内容 begin -->
	...
	<div class="inforight noshow" id="listfav">
		<div class="inforightbt">
			<ul>
				<li class="a_off"><a href="javascript:;" onclick="SFUI.showPeer(\'rightmenu1\');SFMap.isDragend=true;SFMap.gotosearch();">搜索结果</a></li>
				<li class="line"></li>
				<li class="a_on">我的收藏</li>
			</ul>
		</div>
		<!-- 我的收藏内容 begin -->
		<div class="inforightnr">
			<div id="noFav">
				...
				<div class="mycollectionno"><strong>您没有收藏任何楼盘</strong></div>
				<div class="description">
					<ul>
						<li>您可以：</li><li>&nbsp;&nbsp;1.点击地图中的楼盘</li>
						<li>&nbsp;&nbsp;2.点击“收藏”</li>
						<li>&nbsp;&nbsp;3.收藏成功</li>
						<li>注意：您最多收藏10个楼盘</li>
					</ul>
			...
			<div id="haveFav" style="display:none;">
				<div class="mycollectionbt">以下是您收藏过的楼盘：<span>[<a href="javascript:;" onclick="SFMap.clearFavorite();">清空收藏</a>]</span></div>
				<div class="mycollectionnr" id="map_fav"></div>
				<div class="description">
					<ul>
						<li>说明</li>
						<li>1.您最多可收藏10个楼盘</li>
						<li>2.点击<img hspace="2" align="absmiddle" alt="X" src="./img/icon_title03.gif">删除收藏的楼盘</li>
						<li>3.勾选的楼盘将在地图上显示</li>
						<li>4.点击<span class="zi1">[清空收藏]</span>将一次性删除您收藏的所有楼盘</li>
					</ul>
				</div>
			</div>
		</div>
