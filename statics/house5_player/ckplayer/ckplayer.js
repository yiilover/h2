...
function ckcpt(){
	...
	cpt += 'bili.swf,1,1,-180,-100,3|';//比列选择  
...
function ckstyle() { //定义总的风格
	...
	*/
	...
	以下是播放器自带的二个插件
	*/
	ck.control_rel='related.swf,'+APP_PATH+'/index.php?s=content/index/related_xml,0';
	/*
	...
	*/
	ck.pm_repc='_vid_->'+APP_PATH+'index.php?s=content/index/getvideo&id=';
	/*
	...
	*/
	ck.myweb='61495b6c43d19f243d7d07508eaae0b5,ckplayer1,http://www.ckplayer.com,v1.0';
	ck.myright='链接地址,http://www.ckplayer.com,链接地址二,http://www.baidu.com';
	/*
	...
	*/
	ck.cpt_share=APP_PATH+'/index.php?s=content/index/share_xml';
	/*
	分享插件调用的配置文件地址
	调用插件开始
	*/
