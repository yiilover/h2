...
function ckstyle() { //定义总的风格
    var ck = new Object();
    ck.cpath = 'http://www.venfang.com/statics/ckplayer/assets/'; //风格总路径
   // ck.mylogo = 'logo.swf';
    ck.logo = 'cklogo.png,2,115,8';
	...
	ck.control_c='share.swf,1,1,-180,-100,http://www.venfang.com/statics/ckplayer/share.xml,0';//分享按钮的文件，坐标,相关设置的xml文件,编码0是默认的utf-8,1是gbk2312
