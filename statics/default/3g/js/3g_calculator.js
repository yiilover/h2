...
function play(){
    ...
    //hkfs 
	//document.tqhdjsq.tqhkfs[1].checked
    if (document.tqhdjsq.hkfs.value =='2' && document.tqhdjsq.tqhkws.value == '') 	{
        alert('请填入部分提前还款额度');
        return false;
    }
    ...
    //月利率
    //document.tqhdjsq.dklx[0].checked
    if (document.tqhdjsq.hklx.value =='1') {
        if (s_yhkqs > 60) {
	...
	//document.tqhdjsq.dklx[1].checked
    if (document.tqhdjsq.hklx.value =='2') {
        if (s_yhkqs > 60) {
    ...
    if (document.tqhdjsq.hklx.value == '2') {
        ...
        if (tqhkys + yhk >= (dkzys - yhbjs) * (1 + dklv)) {
            ...
            byhk = yhk + tqhkys;
			//clfs
			//document.tqhdjsq.clfs[0].checked
            if (document.tqhdjsq.clfs.value =='1') {
    ...
    //document.tqhdjsq.tqhkfs[0].checked
    if ( document.tqhdjsq.hklx.value =='1' || remark != '') {
