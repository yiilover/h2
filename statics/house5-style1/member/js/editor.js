...
var EDITOR_OPTIONS = {
	...
	extended_valid_elements : "a[class|name|href|target|title|onclick|rel],script[type|src],iframe[src|style|width|height|scrolling|marginwidth|marginheight|frameborder],img[class|src|border=0|width|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name|style],center,$elements",
...
function editor(textarea_id, type, options){
	switch(type){
		case 'complete':
			...
			break;
		case 'small':
			ed_plugins = "cut,copy,paste,safari,pagebreak,style,advimage,advlink,preview,contextmenu,template,inlinepopups,onekeyclear,fullscreen,ct_source";
			ed_theme_advanced_buttons1 = "undo,bold,italic,underline,fontselect,fontsizeselect,forecolor,|,link,unlink,|,justifyleft,justifycenter,justifyright,|,image,onekeyclear,fullscreen,ctSource";
		...
		case 'mini':
			...
			ed_theme_advanced_buttons1 = "undo,bold,italic,underline,fontselect,fontsizeselect,forecolor,|,justifyleft,justifycenter,justifyright,|,onekeyclear,fullscreen";
			ed_theme_advanced_buttons2 = '';
			ed_theme_advanced_buttons3 = '';
			break;
		default:
...
function ajaxfilemanager(field_name, url, type, win) {
	...
	tinyMCE.activeEditor.windowManager.open({
		url: SITEURL+"attachment/index?single=1&tinymce=true&ext_limit="+limit,
		width: 800,
		height: 530,
		inline: "yes",
		close_previous : "no"
