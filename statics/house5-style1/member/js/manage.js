...
function updatesell(hid, catid) {
	...
	$.post(SiteUrl + "index.php?s=member/index/doupdate", {'hid': hid, 'catid': catid, 'doupdate': true}, function(data){
		if(data == 1) {
			alert('刷新成功!');
