...
var artDialog = function (config, ok, cancel) {
	...
	art.HOUSE5_API = art.HOUSE5_API || [];
     var that_Api = art.HOUSE5_API[config.id];
...
artDialog.fn = artDialog.prototype = {
	...
	content: function (msg,url) {
		var prev, next, parent, display,
			...
			if (isIframe) {
				if (typeof h5_hash == 'string') url += (url.indexOf('?') > -1 ? '&': '?') + 'h5_hash=' + h5_hash;
		...
		if (typeof msg === 'string') {
			...
			if (isIframe) art.HOUSE5_API[that.config.id] = msg.contentWindow
		};
